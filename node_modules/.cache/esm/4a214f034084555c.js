let Pot,Room;_408‍.w("./app/envoirement/pot/pot",[["default",["Pot"],function(v){Pot=v}]]);_408‍.w("./app/envoirement/room/room",[["default",["Room"],function(v){Room=v}]]);/**
 ...
 */
  ...
  serverCallRemote(page, action=null){
    ...
    https.get(self.remoteServer+page + '?action=' + action, (resp) => {
      ...
      resp.on('end', () => {
        _408‍.g.console.log(JSON.parse(data));
      });
    }).on("error", (err) => {
      _408‍.g.console.log("Error: " + err.message);
    });
  }
  serverStart(){
    const self = this;
