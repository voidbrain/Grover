...
var DetailPage = /** @class */ (function () {
    ...
    DetailPage.prototype.getItem = function (id) {
        ...
        Promise.all([companiesP, strainsP, g_scenariosP, g_mediumP]).then(function (_a) {
            var companies = _a[0], strains = _a[1], g_scenarios = _a[2], g_mediums = _a[3];
            _this.companies = companies;
            _this.strains = strains;
            _this.g_scenarios = g_scenarios;
            _this.g_mediums = g_mediums;
            console.log(g_mediums);
            if (id) {
