...
class MyMailer extends PHPMailer {
  public function __construct() {
    ...
    $this->Host       = "mail.klekoo.com"; // SMTP server
    $this->SMTPAuth   = true;                  // enable SMTP authentication
    $this->Host       = "mail.klekoo.com"; // sets the SMTP server
    $this->Port       = 587;                    // set the SMTP port for the GMAIL server
    $this->Username   = "smtp4@klekoo.com"; // SMTP account username
    $this->Password   = "smile19742";   
  }
}