<?php 
$items = $db->order_by("posizione", "asc")->get($tabella['main'])->result();
 ?>
...
<a class="btn btn-sm btn-inverse pull-right" href='<?=PATHADMIN?><?=MODULO?>'>
   <i class="fa fa-arrow-left"></i> Lista <?=$soggetti?>
</a>
...
<table class="table table-striped table-bordered ">
	<thead>
		<tr>
            <th class="col col-sm-1" title="Abilitato">Attiva</th>
			<th><?=$soggetto?></th>
            ...
            <tr id="listItem_<?=$item->id?>" class=" depth_1 <?=$row_class?>">
                <td>
                    <div class="btn-group pull-right">
                        <a class="fa fa-arrows handle btn btn-sm" title="sposta" href="#"></a>
