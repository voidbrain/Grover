...
$lista = $modulo->get_item($requestURI[4], $requestURI[5]);
...
$iscritti = $modulo->get_iscritti_lista($lista, TRUE, $requestURI[5]);



?>

<h3>Lista iscritti: <?=$lista->titolo?></h3>
...
<a class="btn btn-sm " href='<?=PATHADMIN?><?=MODULO?>'>
...
<div class="btn-group pull-right">
    ...
    <a class="btn btn-sm fancymedium" href='<?=PATHADMIN?><?=MODULO?>/add_mod/<?=$lista->id?>'>
       <i class="fa fa-edit"></i> Modifica lista
    </a>    
