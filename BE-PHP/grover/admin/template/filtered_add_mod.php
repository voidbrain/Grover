<?php
$id_rif = ($_POST['id']) ? $_POST['id'] : $requestURI[5];
$id_riferimento = ($_POST['id_riferimento']) ? $_POST['id_riferimento'] : $requestURI[4];
$id_rif_2 = ($_POST['id_rif_2']) ? $_POST['id_rif_2'] : $requestURI[6];
	...
	<div class="main_add_mod">
		<div class=" ">
			<fieldset>
				...
				<div class="row">
					<div class="col-sm-12">
						<a class="btn btn-sm btn-inverse" href="<?=PATHADMIN.MODULO?>/<?=$requestURI[4]?>"> <i class="fa fa-arrow-left"></i> Torna a <?=$soggetti?>
						</a>
