...
export class SettingsService {
  ...
  private remoteServerHostname: string = "http://localhost:6400";
  private remoteServerEndpoint: string = "client/";
  private purposes: string[] = ["client", "worker"];
  private purpose: number = Purposes.worker;
  private operatingMode: number | null = null;
  ...
  public getOperatingMode(): number | null {
